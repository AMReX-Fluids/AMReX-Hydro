                            ...
                            bool allow_inflow_on_outflow)
{
        ...
        (has_extdir_or_ho_hi && domain_jhi <= vbx.bigEnd(1)))
    {
        ...
        AMREX_GPU_DEVICE (int i, int j, int k) noexcept
        {
            ...
            HydroBC::SetExtrapVelBCsLo(1, i, j, k, n, vcc, vmns, vpls, d_bcrec[1].lo(1), domain_jlo);
            HydroBC::SetExtrapVelBCsHi(1, i, j, k, n, vcc, vmns, vpls, d_bcrec[1].hi(1), domain_jhi);
        ...
        (has_extdir_or_ho_hi && domain_khi <= wbx.bigEnd(2)))
    {
        ...
        AMREX_GPU_DEVICE (int i, int j, int k) noexcept
        {
            ...
            HydroBC::SetExtrapVelBCsLo(2, i, j, k, n, vcc, wmns, wpls, d_bcrec[2].lo(2), domain_klo);
            HydroBC::SetExtrapVelBCsHi(2, i, j, k, n, vcc, wmns, wpls, d_bcrec[2].hi(2), domain_khi);
