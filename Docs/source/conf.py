# -*- coding: utf-8 -*-
#
# amrex-hydro documentation build configuration file, created by
...
project = u'amrex-hydro'
copyright = u'2017-2018, AMReX-Hydro Team'
author = u'AMReX-Hydro Team'
...
htmlhelp_basename = 'amrex-hydrodoc'
...
latex_documents = [
    (master_doc, 'amrex-hydro.tex', u'AMReX-Hydro Documentation',
     u'AMReX-Hydro Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'amrex-hydro', u'AMReX-Hydro Documentation',
     [author], 1)
]
