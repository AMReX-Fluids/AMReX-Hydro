...
.. math::
   ...
   F^x_{i-\frac{1}{2},j,k}^{n+\frac{1}{2} = a_{i-\frac{1}{2},j,k} \; u^{MAC}_{i-\frac{1}{2},j,k}\; s_{i-\frac{1}{2},j,k}^{n+\frac{1}{2}) 

on all x-faces with non-zero area fraction,

.. math::

   F^y_{i,j-\frac{1}{2},k}^{n+\frac{1}{2} = a_{i,j-\frac{1}{2},k} \; v^{MAC}_{i,j-\frac{1}{2},k}\; s_{i,j-\frac{1}{2},k}^{n+\frac{1}{2}) 

on all y-faces with non-zero area fraction, and

.. math::

   F^z_{i,j,k-\frac{1}{2}}^{n+\frac{1}{2} = a_{i,j,k-\frac{1}{2}} \; w^{MAC}_{i,j,k-\frac{1}{2}}\; s_{i,j,k-\frac{1}{2}}^{n+\frac{1}{2}) 
...
.. math::
   ...
   \nabla \cdot ({\bf u}s) = ( 
                           & ( F^x_{i+\frac{1}{2},j,k}^{{n+\frac{1}{2}}} -F^x_{i-\frac{1}{2},j,k}^{{n+\frac{1}{2}}}) + \\
                           & ( F^y_{i,j+\frac{1}{2},k}^{{n+\frac{1}{2}}} -F^y_{i,j-\frac{1}{2},k}^{{n+\frac{1}{2}}}) + \\
                           & ( F^z_{i,j,k+\frac{1}{2}}^{{n+\frac{1}{2}}} -F^z_{i,j,k-\frac{1}{2}}^{{n+\frac{1}{2}}}) ) / V_{i,j,k}
